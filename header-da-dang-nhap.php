    ...
    <ul class="danh-muc-dropdown-content">
        ...
        <?php endforeach; ?>
                ...
                <li class="search-container">
                    <form action="tim-kiem-da-dang-nhap.php" method="get">
                        <input type="text" name="query" placeholder="Tìm kiếm sản phẩm..." class="search-input" value="<?= (basename($_SERVER['PHP_SELF']) == 'tim-kiem-da-dang-nhap.php') ? htmlspecialchars($query) : '' ?>">
